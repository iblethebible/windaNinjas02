# Winda Ninjas - Job Management System (BUILD ONE READY TO TEST EXAMPLES IN TESTS.TXT)

A comprehensive Flask web application for managing window cleaning jobs, customers, zones, and worker tracking.
